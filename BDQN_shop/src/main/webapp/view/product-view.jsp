...
<div id="position" class="wrap">
	...
	</a> &gt; <c:out value="${info.epName}"></c:out>
</div>
<div id="main" class="wrap">
	...
	<div id="product" class="main">
			<h1>${info.epName }</h1>
			<div class="infos">
			<div class="thumb"><img src="${path }/images/product/${info.epFileName }" width="110" height="106" /></div>
			<div class="buy">
				商城价：<span class="price">￥${info.epPrice }</span><br />
				库　存：${info.epStockStr }
			  <div class="button">
			  		<input type="button" name="button" value="" onclick="location.href = '${path }/checkLogin?action=js&epid=${info.epId }'" />
			  		<a href="checkLogin?action=jr&epid=${info.epId }">放入购物车</a>
			  </div>
			</div>
			<div class="clear"></div>
		</div>

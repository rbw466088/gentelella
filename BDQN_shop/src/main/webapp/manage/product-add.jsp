...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>添加商品</h2>
		<div class="manage">
			<form id="myFrom" action="ProductAdd" method="post" enctype="multipart/form-data" method="post">
				<table class="form">
					<tr>
						<td class="field">商品名称(*)：</td>
						<td><input type="text" class="text" name="productName" id="productName" /><span id="DivproductName"></span></td>
					</tr>
                    <tr>
						<td class="field">描述：</td>
						<td><input type="text" class="text" name="productDetail" id="productms" /><span id="Divproductms"></span></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text tiny" name="productPrice" id="productPrice" /> （元）<span id="DivproductPrice"></span></td>
					</tr>
					
					<tr>
						<td class="field">库存(*)：</td>
						<td><input type="text" class="text tiny" name="productNumber" id="products" /><span id="Divproducts"></span></td>
					</tr>
					<tr>

...
<div id="header" class="wrap">
	...
	<div class="navbar">
		<ul class="clearfix">
			...
			<li class="current"><a href="News?actions=user">用户</a></li>
			<li><a href="#">商品</a></li>
			<li><a href="HouTaiDinDan?actions=user">订单</a></li>
			<li><a href="#">留言</a></li>
			<li><a href="#">新闻</a></li>
		</ul>
	</div>
	...
	<div class="main">
		...
		<div class="manage">
			<table class="list">
				...
				<c:forEach items="${newin}" var="in" varStatus="vs">
				<tr>
					<td class="first w4 c">${in.id }</td>
					<td class="w1 c">${in.name }</td>
					<td class="w2 c">${in.sexs}</td>
					<td>${in.email}</td>
					<td class="w4 c">${in.mobile }</td>
					<td class="w1 c"><a href="InfoServlet?id=${in.id}">修改</a></td>
				</tr>
			</c:forEach>
			</table>
		</div>
